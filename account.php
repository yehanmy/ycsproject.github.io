...
<div class="row">
<div class="col-lg-6">
<span class="logo">YCS PROJECT ONLINE EXAMINATION PORTAL</span></div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">M.H. Yehan Wasura(Leader) & Pansilu Pabasara(member)</a>
		<h4 style="font-family:'typo' ">yehanth8@gmail.com</h4>
		<h4 style="font-family:'typo' ">O.K.I. International School, Biyagama</h4></div></div>
		</p>
      </div>
